...
const navItems = [
  ...
  { to: '/repair-appointments', label: 'Запись на ремонт', icon: CalendarClock },
  { to: '/movement-documents', label: 'Перемещение товаров', icon: ArrowLeftRight },
  { to: '/supplier-orders', label: 'Заказы поставщику', icon: Truck },
  { to: '/customer-orders', label: 'Заказы покупателя', icon: ShoppingCart },
