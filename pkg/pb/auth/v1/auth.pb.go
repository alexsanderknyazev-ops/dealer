...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\"m\n" +
	"\x0fRegisterRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05phone\x18\x04 \x01(\tR\x05phone\"s\n" +
	...
	"\x05valid\x18\x03 \x01(\bR\x05valid2\x80\x04\n" +
	"\vAuthService\x12Y\n" +
	"\bRegister\x12\x18.auth.v1.RegisterRequest\x1a\x19.auth.v1.RegisterResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/api/register\x12M\n" +
	"\x05Login\x12\x15.auth.v1.LoginRequest\x1a\x16.auth.v1.LoginResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/api/login\x12U\n" +
	"\aRefresh\x12\x17.auth.v1.RefreshRequest\x1a\x18.auth.v1.RefreshResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/api/refresh\x12Q\n" +
	"\x06Logout\x12\x16.auth.v1.LogoutRequest\x1a\x17.auth.v1.LogoutResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/api/logout\x12P\n" +
	"\bValidate\x12\x18.auth.v1.ValidateRequest\x1a\x19.auth.v1.ValidateResponse\"\x0f\x82\xd3\xe4\x93\x02\t\x12\a/api/me\x12K\n" +
	"\x0eRegisterClient\x12\x1e.auth.v1.RegisterClientRequest\x1a\x19.auth.v1.RegisterResponseB0Z.github.com/dealer/dealer/pkg/pb/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*RegisterClientRequest)(nil), // 1: auth.v1.RegisterClientRequest
	...
	(*ValidateRequest)(nil),       // 9: auth.v1.ValidateRequest
	(*ValidateResponse)(nil),      // 10: auth.v1.ValidateResponse
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	5,  // 2: auth.v1.AuthService.Refresh:input_type -> auth.v1.RefreshRequest
	7,  // 3: auth.v1.AuthService.Logout:input_type -> auth.v1.LogoutRequest
	9,  // 4: auth.v1.AuthService.Validate:input_type -> auth.v1.ValidateRequest
	1,  // 5: auth.v1.AuthService.RegisterClient:input_type -> auth.v1.RegisterClientRequest
	...
	8,  // 9: auth.v1.AuthService.Logout:output_type -> auth.v1.LogoutResponse
	10, // 10: auth.v1.AuthService.Validate:output_type -> auth.v1.ValidateResponse
	2,  // 11: auth.v1.AuthService.RegisterClient:output_type -> auth.v1.RegisterResponse
