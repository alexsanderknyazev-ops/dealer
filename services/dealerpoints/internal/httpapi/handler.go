...
func (h *Handler) RegisterRoutes(mux *http.ServeMux) {
	// Dealer points
	mux.HandleFunc("GET /api/dealer-points", h.cors(h.auth(h.handleListDealerPoints)))
	mux.HandleFunc("POST /api/dealer-points", h.cors(h.auth(h.handleCreateDealerPoint)))
	mux.HandleFunc("GET /api/dealer-points/{id}", h.cors(h.auth(h.handleGetDealerPoint)))
	mux.HandleFunc("PUT /api/dealer-points/{id}", h.cors(h.auth(h.handleUpdateDealerPoint)))
	mux.HandleFunc("DELETE /api/dealer-points/{id}", h.cors(h.auth(h.handleDeleteDealerPoint)))
	// Legal entities
	mux.HandleFunc("GET /api/legal-entities", h.cors(h.auth(h.handleListLegalEntities)))
	mux.HandleFunc("POST /api/legal-entities", h.cors(h.auth(h.handleCreateLegalEntity)))
	mux.HandleFunc("GET /api/legal-entities/{id}", h.cors(h.auth(h.handleGetLegalEntity)))
	mux.HandleFunc("PUT /api/legal-entities/{id}", h.cors(h.auth(h.handleUpdateLegalEntity)))
	mux.HandleFunc("DELETE /api/legal-entities/{id}", h.cors(h.auth(h.handleDeleteLegalEntity)))
	mux.HandleFunc("GET /api/dealer-points/{id}/legal-entities", h.cors(h.auth(h.handleListLegalEntitiesByDealerPoint)))
	mux.HandleFunc("POST /api/dealer-points/{id}/legal-entities", h.cors(h.auth(h.handleLinkLegalEntity)))
	mux.HandleFunc("DELETE /api/dealer-points/{dpId}/legal-entities/{leId}", h.cors(h.auth(h.handleUnlinkLegalEntity)))
	// Warehouses
	mux.HandleFunc("GET /api/warehouses", h.cors(h.auth(h.handleListWarehouses)))
	mux.HandleFunc("POST /api/warehouses", h.cors(h.auth(h.handleCreateWarehouse)))
	mux.HandleFunc("GET /api/warehouses/{id}", h.cors(h.auth(h.handleGetWarehouse)))
	mux.HandleFunc("PUT /api/warehouses/{id}", h.cors(h.auth(h.handleUpdateWarehouse)))
	mux.HandleFunc("DELETE /api/warehouses/{id}", h.cors(h.auth(h.handleDeleteWarehouse)))
	mux.HandleFunc("OPTIONS /api/dealer-points", h.cors(nil))
	mux.HandleFunc("OPTIONS /api/legal-entities", h.cors(nil))
	mux.HandleFunc("OPTIONS /api/warehouses", h.cors(nil))
}
