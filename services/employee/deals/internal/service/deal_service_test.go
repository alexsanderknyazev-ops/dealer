...
func TestDealService_Create_InvalidCustomer(t *testing.T) {
	s := NewDealService(&memDealRepo{}, nil, nil)
...
func TestDealService_Create_ReferenceIntegrity(t *testing.T) {
	...
	s1 := NewDealService(&memDealRepo{}, &memRefs{custOK: &customerMissing}, nil)
	...
	s2 := NewDealService(&memDealRepo{}, &memRefs{vehOK: &vehicleMissing}, nil)
...
func TestDealService_Get_NotFound(t *testing.T) {
	s := NewDealService(&memDealRepo{byID: map[uuid.UUID]*domain.Deal{}}, nil, nil)
...
func TestDealService_Create_Err(t *testing.T) {
	s := NewDealService(&memDealRepo{byID: map[uuid.UUID]*domain.Deal{}, err: errors.New("db")}, nil, nil)
...
func TestDealService_Update_ReferenceIntegrity(t *testing.T) {
	...
	s2 := NewDealService(r, &memRefs{custOK: &missing}, nil)
