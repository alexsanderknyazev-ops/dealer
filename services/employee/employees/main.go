...
import (
	...
	"github.com/dealer/dealer/services/employees/internal/config"
	grpcserver "github.com/dealer/dealer/services/employees/internal/grpc"
	"github.com/dealer/dealer/services/employees/internal/repository"
	"github.com/dealer/dealer/services/employees/internal/service"
)

const serviceName = "employees-service"
...
func main() {
	...
	pool, err := postgres.NewPool(ctx, cfg.PostgresDSN, dbschema.Employees, dbschema.Public)
	if err != nil {
	...
	employeesv1.RegisterEmployeesServiceServer(gsrv, grpcserver.NewServer(svc))
